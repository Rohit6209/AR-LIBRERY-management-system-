...
const MemberSchema = new Schema({
  ...
  // ✅ true = dueAmount ko explicit source-of-truth maano (Edit Due / Collect Fee se set),
  // UI dues list ko fee_records se recompute karke isko overwrite nahi karna chahiye
  dueAmountManual: { type: Boolean, default: false },
